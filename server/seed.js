...
const initialCourses = [
  { 
    ...
    modules: [
      { title: 'Welcome to the Course', type: 'video', contentUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
      ...
      { title: 'Components and Props', type: 'video', contentUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' }
    ]
  },
  { 
    title: 'Advanced CSS Layouts', instructor: 'Aryan Raj', level: 'Intermediate', duration: '3 Weeks',
    modules: [
      { title: 'Flexbox Deep Dive', type: 'video', contentUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
  ...
  { 
    ...
    modules: [
      ...
      { title: 'Creating REST APIs', type: 'video', contentUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' }
    ]
  },
  { 
    title: 'UI/UX Design Principles', instructor: 'Riya', level: 'Beginner', duration: '2 Weeks',
    modules: [
      { title: 'Color Theory', type: 'video', contentUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
